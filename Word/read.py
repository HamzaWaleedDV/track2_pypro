...
doc = docx.Document(Path.home() / Path('OneDrive', 'Desktop', 'word file', 'academy_1.docx'))
...
print(readDocx.getText(Path.home() / Path('OneDrive', 'Desktop', 'word file', 'academy_1.docx')))